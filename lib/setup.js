...
async function _default() {
  ...
  try {
    ...
    if (tableNames && tableNames.length > 0) {
      const relevantTables = (0, _getRelevantTables.default)(tableNames, newTables);
      await (0, _deleteTables.default)(dynamoDB, relevantTables);
      debug(`relevant tables`, {
        relevantTables,
        newTables
      });
    }
  ...
  debug(`created tables`, {
    createdTables,
    response,
    dynamoDB,
    endpoint: dynamoDB.config
  });
}
